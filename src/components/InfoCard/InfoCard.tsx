...
export const InfoCard = ({ image, headerText, pa, pb, pc, pd, url, bgImage}:
    ...
    return (
        <div className={"flex border font-roboto rounded-md p-6 shadow-md flex-row space-x-8 bg-c-background bg-opacity-80"} style={{backgroundImage: `url(${bgImage})`, backgroundPosition:'center', backgroundSize: 'cover', backgroundBlendMode: 'lighten'}}>
